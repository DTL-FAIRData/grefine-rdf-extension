...
public class PreviewRdfValueExpressionCommand extends PreviewExpressionCommand {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (rowIndicesString == null) {
                respond(response,
                        "{ \"code\" : \"error\", \"message\" : \"No row indices specified\" }");
                return;
            }
    ...
    private void respondUriPreview(Project project, JSONWriter writer, JSONArray rowIndices,
            String expression, String columnName, URI base) throws JSONException {
        ...
        try {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (rowIndex >= 0 && rowIndex < project.rows.size()) {
                    ...
                    result = Util.evaluateExpression(project, expression, columnName, row,
                            rowIndex);
                }
                ...
                if (result == null) {
                    ...
                    if (result.getClass().isArray()) {
                        ...
                        for (int k = 0; k < lngth; k++) {
                            resolvedUrisVal
                                    .append(Util.resolveUri(base, Array.get(result, k).toString()));
                            if (k < lngth - 1) {
    ...
    private void respondLiteralPreview(Project project, JSONWriter writer, JSONArray rowIndices,
            String expression, String columnName) throws JSONException {
        int length = rowIndices.length();
