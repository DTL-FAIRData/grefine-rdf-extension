...
public class VocabularyImporter {
    ...
    protected void getTerms(Repository repos, String name, String uri, List<RDFSClass> classes,
            List<RDFSProperty> properties) throws VocabularyImportException {
        try {
    ...
    private boolean faultyContentNegotiation(String uri) {
        // we add an exceptional treatment for SKOS as their deployment does not handle Accept
        // header properly
        // SKSO always return HTML if the Accept header contains HTML regardless the other more
        // preferred options
