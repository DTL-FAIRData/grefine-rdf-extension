...
public class RDFNode implements Jsonizable {
    ...
    public RDFNode(String uRI, String label, String description, String prefix,
            String vocabularyUri) {
        this(uRI, label, description, prefix, vocabularyUri, "");
        this.localPart = extractlocalPart();
    }

    // TODO - refactor this constructor... it has amny arguments and of the same type. Use helper
    // class? builder?
    public RDFNode(String uRI, String label, String description, String prefix,
            String vocabularyUri, String lPart) {
        this.description = description;
        URI = uRI;
        this.label = label;
