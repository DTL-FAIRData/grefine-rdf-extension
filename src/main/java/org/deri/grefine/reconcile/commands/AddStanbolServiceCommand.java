...
public class AddStanbolServiceCommand extends Command {
    ...
    /**
     * Processes the pre-registration of an instance of Apache Stanbol, returning the list of
     * suitable reconciliation services available
     * 
     */
    @Override
    ...
    private Set<ReconciliationStanbolSite> retrieveReconciliations(String uri)
        ...
        Set<String> sites =
                mapper.readValue(entity.getContent(), new TypeReference<Set<String>>() {});
        ...
        for (String site : sites) {
            ...
            if (reconciliation != null) {
                ...
                log.error("'" + site
                        + "' can't be correctly retrieved, so not going to be registered");
            }
        }
    ...
    private void serializeReconciliations(HttpServletResponse res,
            Set<ReconciliationStanbolSite> reconciliations) throws IOException {
