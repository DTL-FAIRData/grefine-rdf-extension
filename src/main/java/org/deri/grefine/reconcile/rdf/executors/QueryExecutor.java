...
/**
 * @author fadmaa this interface takes care of executing SPARQL queries. the RDF to query might be a
 *         dump or a remote SPARQL endpoint. different implementation should take care of this.
 */
