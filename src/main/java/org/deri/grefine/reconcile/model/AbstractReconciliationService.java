...
/**
 * @author fadmaa implement the multi-query mode reconciliation based on repetitive application of
 *         single-query reconcile
 *         {@link org.deri.grefine.reconcile.model.ReconciliationService#reconcile(ReconciliationRequest)}
 * 
 */
