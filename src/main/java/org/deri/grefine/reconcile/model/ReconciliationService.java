...
public interface ReconciliationService {
     ...
     *         {@link org.deri.grefine.reconciliation.rdf.RdfReconciliationService
     *         RdfReconciliationService} provides default implementation based on
     *         {@link #reconcile(ReconciliationRequest)}
     */
    public ImmutableMap<String, ReconciliationResponse> reconcile(
            ImmutableMap<String, ReconciliationRequest> multiQueryRequest);
    ...
    /**
     * used for autocomplete subjectTypeUri restricts properties to only those satisfying (s,p,o)
     * exists ans s is of type subjectTypeId
     * 
     * @param prefix the query string
     * @param subjectTypeId the ID of the
     * @return ranked list of properties matching the prefix and have a subject of type
     *         subjectTypeId
     */
    ...
    /**
     * @param typeId
     * @return HTML for type preview. this should be an HTML portion and not a full document(i.e.
     *         DIV (without HEAD, BODY...) ) should give a good brief overview of the type
     *         identified by typeId to help the user identify it
     */
    public String getPreviewHtmlForType(String typeId) throws Exception;

    /**
     * @param propertyId
     * @return HTML for property preview. this should be an HTML portion and not a full
     *         document(i.e. DIV (without HEAD, BODY...) ) should give a good brief overview of the
     *         property identified by propertyId to help the user identify it
     */
    public String getPreviewHtmlForProperty(String propertyId) throws Exception;

    /**
     * @param resourceId
     * @return HTML for resource preview. this should be an HTML portion and not a full
     *         document(i.e. DIV (without HEAD, BODY...) ) should give a good brief overview of the
     *         resource identified by resourceId to help the user identify it
     */
    ...
    /**
     * save the data if any. this method should only save the data of the service not its metadata.
     * metadata is id, name and other configuration example of data to be save is the RDF model for
     * a dump-based service.
     */
    ...
    /**
     * @param in inputstream to read a file containing a model for the service(dump-based only) in
     *        Turtle.
     */
