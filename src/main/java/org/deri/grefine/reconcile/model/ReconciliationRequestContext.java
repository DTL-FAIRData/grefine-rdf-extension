...
/**
 * @author fadmaa complex reconciliation requests will use additional properties to make
 *         reconciliation more precise... this class is used to represent these additional
...
public class ReconciliationRequestContext {
    ...
    public ReconciliationRequestContext(PropertyContext... prop) {
        this.properties = new LinkedHashSet<ReconciliationRequestContext.PropertyContext>(
                Arrays.asList(prop));
    }
    ...
    /**
     * @author fadmaa A property id and its value
     */
